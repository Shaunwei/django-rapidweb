...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT,'test.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'x+zod9blpbg#&_%%#yp9j0x+s7hsk=xqa-tz*a(!k48o%zzvcj'
...
ROOT_URLCONF = 'rapidweb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidweb.wsgi.application'
